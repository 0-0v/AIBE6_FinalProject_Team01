...
public enum PlaceErrorCode implements ErrorCode {
    ...
    PLACE_VOTE_NOT_FOUND(HttpStatus.NOT_FOUND, "PLACE_VOTE_NOT_FOUND", "장소 투표를 찾을 수 없습니다."),
    PLACE_VOTE_CLOSED(HttpStatus.CONFLICT, "PLACE_VOTE_CLOSED", "이미 종료된 장소 투표입니다."),
    PLACE_VOTE_INVALID_INPUT(HttpStatus.BAD_REQUEST, "PLACE_VOTE_INVALID_INPUT", "투표 유형과 선택지를 확인해주세요."),
