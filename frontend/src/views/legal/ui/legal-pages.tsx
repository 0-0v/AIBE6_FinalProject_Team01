...
const privacySections: Section[] = [
    ...
    },
    {
        title: '3. 보유 및 이용 기간',
        paragraphs: [
            '회원정보와 이용자가 생성한 콘텐츠는 원칙적으로 회원 탈퇴 또는 처리 목적 달성 시 지체 없이 파기합니다.',
            '다만 반복 가입, 계정 악용 및 제재 회피 방지를 위해 이메일과 소셜 제공자 식별값을 그대로 보관하지 않고 일방향 변환한 값, 탈퇴일 및 제재 이력 등 최소 정보만 별도 분리하여 탈퇴일로부터 10년간 보관합니다. 해당 정보는 부정 이용 방지 목적으로만 접근합니다.',
